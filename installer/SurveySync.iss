...
OutputDir=output
OutputBaseFilename=SurveySync_Setup_9.3.0
...
VersionInfoVersion=9.3.0.0
VersionInfoTextVersion=9.3.0
...
VersionInfoProductVersion=9.3.0
...
[InstallDelete]
; v9.3.0 is an in-place SurveySync feature update and retains the FieldBook Sync migration cleanup.
